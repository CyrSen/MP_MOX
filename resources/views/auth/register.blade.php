...
<section id="register">
    <div class="rgba-black-strong"></div>
        <div class="container py-5">
            <div id="{{-- animationDownReg --}}" class="wow fadeInRight" data-wow-delay=".4s">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                <div id="{{-- animationUpReg --}}" class="card mb-5 wow fadeInRight" data-wow-delay=".4s" style="max-width: 800px;">
