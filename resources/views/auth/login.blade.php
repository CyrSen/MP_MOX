...
<section id="login">
    <div class="rgba-black-strong"></div>
        <div class="container py-5">
            <div id="{{-- animationDown --}}" class=" animate__animated animate__fadeInDown animate__delay-2s">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                <div id="{{-- animationUp --}}" class="card mb-5 animate__animated animate__fadeInUp animate__delay-2s" style="max-width: 800px;">
