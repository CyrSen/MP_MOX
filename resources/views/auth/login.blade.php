    ...
    <section id="login">
        ...
        <div class="container py-5">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div id="{{-- animationUp --}}" class="card mb-5 animate__animated animate__fadeInUp animate__delay-1s"
                            ...
                            <div class="row justify-content-center">
                                <form class="col-11 col-md-10" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="text-center">
                                        <button class="btn btn-indigo my-3" type="submit" style="color:white"><i
                                                class="fa-regular fa-paper-plane"></i></i> {{ __('Senden') }}</button>
                                        <p class="pt-3">Noch keinen Account? <a
