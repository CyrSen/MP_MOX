          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <h6 class="font-weight-medium text-white mb-4">Du möchtest nicht mehr frieren? Hier sind einige Tipps:</h6>
                <button class="btn btn-indigo text-white btn-rounded" type="button" onclick="openPopup('popup-kalt')">Tipps Kälte</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <h6 class="font-weight-medium text-white mb-4">Ist dir im Büro zu warm? Dann lies diese Tipps:</h6>
                <button class="btn btn-indigo text-white btn-rounded" type="button" onclick="openPopup('popup-heiss')">Tipps Hitze</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <h6 class="font-weight-medium text-white mb-4">Möchtest du weniger Lärmbelastung? Lies diese Tipps:</h6>
                <button class="btn btn-indigo text-white btn-rounded" type="button" onclick="openPopup('popup-laerm')">Tipps Lärm</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="card-body">
                ...
                <h6 class="font-weight-medium text-white mb-4">Dicke Luft im Office? Diese Tipps können helfen:</h6>
                <button class="btn btn-indigo text-white btn-rounded" type="button" onclick="openPopup('popup-luft')">Tipps Luft</button>
              </div>
            </div>
          </div>
        </div>
