...
@section('content')
    ...
    <section id="feedback" {{-- style="margin-bottom:10rem;" --}}>
        ...
        <div class="container py-1">
            ...
            <form action="{{ route('feedback.store', ['feedbackMapId' => $feedbackMapId]) }}" method="POST">
                ...
                <div class="row justify-content-center mt-5 mt-md-3 pt-4 pt-md-0">
                    <div id="{{-- animationLeft --}}" class="col-md-6 mt-3 mb-5 animate__animated animate__fadeInLeft animate__delay-1s">
        ...
        <div id="{{-- animationRight --}}" class="col-md-6 mt-3 mb-5 animate__animated animate__fadeInRight animate__delay-1s">
            <div class="card mx-auto h-100" style="background-color: rgba(233, 228, 224, 0.8);">
