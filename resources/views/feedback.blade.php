...
@section('content')
    ...
    <section id="feedback" {{-- style="margin-bottom:10rem;" --}}>
        ...
        <div class="container py-1">
            ...
            <form action="{{ route('feedback.store', ['feedbackMapId' => $feedbackMapId]) }}" method="POST">
                ...
                <div class="row justify-content-center mt-5 mt-md-3 pt-4 pt-md-0">
                    <div id="{{-- animationLeft --}}" class="col-md-6 mb-5 animate__animated animate__fadeInLeft animate__delay-1s">
                        <div class="card mx-auto mt-5" style="background-color: rgba(233, 228, 224, 0.8);">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center pt-1 pb-0 px-1 px-md-3">
                                <!-- Content of Card 1 -->
                                <div class="col">
        ...
        <div id="{{-- animationRight --}}" class="col-md-6 mb-5 animate__animated animate__fadeInRight animate__delay-1s">
            <div class="card mx-auto mt-5" style="background-color: rgba(233, 228, 224, 0.8);">
                        ...
                        <div class="emoji-selection mt-2 mb-2 px-2 mb-4"
                            ...
                            <div class="icon-wrapper icon-element">
                                <img class="feedbackEmojis img-fluid  p-2 tooltip-icon"
                                    ...
                                    data-bs-custom-class="custom-tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Leise" data-bs-value="3"
                                    onclick="setNoiseLevel(3)" style="position: relative; left: 3px;">
                            </div>
                            <div class="icon-wrapper icon-element">
                                <img class="feedbackEmojis img-fluid  p-2 tooltip-icon"
                                    src="./assets/img/icons_var/smiley_new_excellent.svg" alt="smiley-ok"
                                    data-bs-custom-class="custom-tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Optimal" data-bs-value="5"
                            ...
                            <div class="icon-wrapper icon-element">
                                <img class="feedbackEmojis img-fluid  p-2 tooltip-icon"
                                    ...
                                    data-bs-custom-class="custom-tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Zu laut" data-bs-value="1"
                        ...
                        <div class="emoji-selection mt-2 mb-2 px-2 mb-4"
                            ...
                            <div class="icon-wrapper icon-element">
                                <img class="feedbackEmojis img-fluid  p-2 tooltip-icon"
                                    ...
                                    data-bs-custom-class="custom-tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Gut" data-bs-value="4"
                            ...
                            <div class="icon-wrapper icon-element">
                                <img class="feedbackEmojis img-fluid  p-2 tooltip-icon"
                                    src="./assets/img/icons_var/smiley_new_poor.svg" alt="smiley-meh"
                                    data-bs-custom-class="custom-tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Mässig" data-bs-value="2"
                            ...
                            <div class="icon-wrapper icon-element">
                                <img class="feedbackEmojis img-fluid  p-2 tooltip-icon"
                                    ...
                                    data-bs-custom-class="custom-tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Schlecht"
