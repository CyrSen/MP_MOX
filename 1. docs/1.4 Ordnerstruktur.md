...
2.1.1 index.html: 
Diese Datei ist die Hauptseite der Web-App und enthält die Registrierungs- und Login-Formulare für Büro-Arbeitende und Facility Manager.
...
2.1.6 add-facility-manager.html: 
